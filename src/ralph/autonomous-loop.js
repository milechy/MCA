...
const LOOP_PHASES = Object.freeze({ PLAN: 'PLAN', PLAN_APPROVAL_PENDING: 'PLAN_APPROVAL_PENDING', OPENCODE_RUNNING: 'OPENCODE_RUNNING', PATCH_PREVIEW: 'PATCH_PREVIEW', DIFF_APPROVAL_PENDING: 'DIFF_APPROVAL_PENDING', APPLY: 'APPLY', GATES: 'GATES', FIX_LOOP: 'FIX_LOOP', COMMIT_APPROVAL_PENDING: 'COMMIT_APPROVAL_PENDING', COMMIT: 'COMMIT', PUSH_APPROVAL_PENDING: 'PUSH_APPROVAL_PENDING', PR_APPROVAL_PENDING: 'PR_APPROVAL_PENDING', DONE: 'DONE', STOPPED: 'STOPPED', ESCALATED: 'ESCALATED' });
